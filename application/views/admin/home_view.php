	...
	<div id="body-wrapper">
		...
		<div id="main-content">
			<!-- <ul class="shortcut-buttons-set">
				...
				<li>
					<a class="shortcut-button" href="<?php echo base_url();?>index.php/admin/contacts/add">
						<span>
							<img src="<?php echo base_url();?>public/backend/images/icons/address_book_icon.png" alt="icon" /><br />
							Adicionar contacto
						</span>
					</a>
				</li>
